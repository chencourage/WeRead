...
public class PayController extends BaseController {
     ...
     */
    @PostMapping("aliPay")
    public void aliPay(Integer payAmount,HttpServletRequest request,HttpServletResponse httpResponse) throws Exception {
    ...
    public void aliPayNotify(HttpServletRequest request,HttpServletResponse httpResponse) throws Exception{
